...
function youtubeDl (binary, args, options, cb) {
  return execa(binary, args, options, function done (err, output) {
 ...
 */
function call (binary, urls, args1, args2, options = {}, cb) {
  let args = args1
  ...
  return youtubeDl(binary, args, options, cb)
}
 ...
 * @param {Function(!Error, String)} cb
 */
ytdl.exec = function exec (binary, url, args, options, cb) {
  return call(binary, url, [], args, options, cb)
}
 ...
 */
ytdl.getInfo = function getInfo (binary, url, args, options, cb) {
  ...
  call(binary, url, defaultArgs, args, options, function done (err, data) {
    if (err) return cb(err)
    let info
